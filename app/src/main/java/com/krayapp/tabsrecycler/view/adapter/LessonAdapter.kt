...
class LessonAdapter(private val adapterDelegate: AdapterDelegate?) :
    ListAdapter<Lesson, LessonViewHolder>(LessonDiffUtil) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): LessonViewHolder =
        LessonViewHolder(
            LayoutInflater.from(parent.context)
                .inflate(R.layout.lesson_template_first, parent, false)
        )
...
class LessonViewHolder(view: View) : RecyclerView.ViewHolder(view) {
    private val viewBinding: LessonTemplateFirstBinding by viewBinding()
